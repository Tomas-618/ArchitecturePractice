...
{
    public class PlayerWalkToCrouchTransition : GameLoopTransition
    {
        private readonly PlayerCrouch _playerCrouch;

        public PlayerWalkToCrouchTransition(PlayerCrouch playerCrouch, GameLoopState nextState) : base(nextState) =>
            _playerCrouch = playerCrouch ?? throw new ArgumentNullException(nameof(playerCrouch));

        protected override bool CheckCondition() =>
            _playerCrouch.IsCrouching;
    }
}
